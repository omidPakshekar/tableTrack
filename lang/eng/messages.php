...
return array(
    ...
    'paxExceedsRemainingSeats' => ':pax pax exceeds remaining seats (:remaining) for table :table.',
    'tableSeatsFull' => 'Table :table has no remaining seats. Open an existing order or choose another table.',
    ...
    'posOfflineFeatureUnavailable' => 'This action needs a connection. Please reconnect and try again.',
    ...
    'creatingOrderPleaseWait' => 'Please wait. Do not close this page or try to pay again.',
    ...
    'waiterRequestAlreadyPending' => 'A waiter has already been notified for this table. Please wait until they attend your request.',
    'waiterRequestCooldown' => 'Please wait :time before calling the waiter again.',
    'waiterRequestCooldownSeconds' => ':seconds seconds',
    'waiterRequestCooldownMinutes' => ':minutes minutes',
    ...
    'restaurantCannotCloseUntilSettled' => 'Cannot close the restaurant until open tables and unpaid billed orders are settled.',
    ...
    'pleaseSelectAtLeastOneTableToMerge' => 'Please select at least one table to merge.',
    'tablesMergedSuccessfully' => 'Tables merged successfully.',
    'errorSettingOrderType' => 'Error setting order type: :message',
    'pleaseSelectFutureTime' => 'Please select a future time.',
);
