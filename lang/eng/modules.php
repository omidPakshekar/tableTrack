...
return [
    'menu' => [
        ...
        'sellByWeightHelp' => 'Enable for sweets, dry fruits, spices, etc. Price is per kilogram. Cashiers enter grams or kg on POS. Works with or without Inventory.',
        'pricePerKg' => 'Price (per kg)',
        'directSaleSku' => 'Direct Sale SKU',
        'directSaleSkuHelp' => 'Optional. Link a packaged inventory item so each POS sale deducts 1 unit (water, cans, snacks). Leave empty for cooked dishes with multi-ingredient recipes.',
        'directSaleSkuNone' => 'None (use Recipes screen)',
    ...
    'order' => [
        ...
        'weightUnitGrams' => 'g',
        'weightUnitKg' => 'kg',
        'weightPresets' => 'Quick select',
        'pricePerKg' => 'Price / kg',
        'weightTotal' => 'Total',
        'addWeightToCart' => 'Add to Cart',
    ...
    'settings' => [
        ...
        'cannotCloseRestaurantTitle' => 'Cannot Close Restaurant',
        'cannotCloseRestaurantDetail' => 'Settle open tables and unpaid billed orders before closing the restaurant.',
        'cannotCloseOpenTables' => 'Open tables',
        'cannotCloseUnpaidBilledOrders' => 'Unpaid billed orders',
        ...
        'isChargeTaxable' => 'Apply Tax (GST)',
        'isChargeTaxableDescription' => 'Check to include this charge amount in tax (GST) calculation.',
        'chargeTaxable' => 'Apply Tax',
